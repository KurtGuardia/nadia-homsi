...
export default function Footer () {
  ...
  const month = date.toLocaleString( 'es-ES', { month: 'short' } ).charAt( 0 ).toUpperCase() + date.toLocaleString( 'es-ES', { month: 'short' } ).slice( 1 );
      ...
      <div className="container mx-auto text-center">
        ...
        <p>&copy; {copyrightYear} desarrollado por
          <span className="inline-block transition-all duration-300 ease-in-out hover:rotate-[10deg] hover:scale-110 hover:animate-pulse">
            <a href="https://kurtguardia.com" target="_blank" rel="noopener noreferrer">
              &nbsp; Kurt Guardia.
            </a>
          </span>
